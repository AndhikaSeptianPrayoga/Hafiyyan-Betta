  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Admin Routes */}
        <Route path="/admin" element={<EnhancedAdminLayout children={<EnhancedDashboard />} />} />
        <Route
          path="/admin/artikel"
          element={<EnhancedAdminLayout children={<EnhancedArtikelAdmin />} />}
        />
        <Route
          path="/admin/kebutuhan"
          element={<EnhancedAdminLayout children={<EnhancedKebutuhanAdmin />} />}
        />
        <Route
          path="/admin/ikan"
          element={<EnhancedAdminLayout children={<EnhancedIkanAdmin />} />}
        />
      </Routes>
    </BrowserRouter>
  )
